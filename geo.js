...
function getPlaceDesc(placeDescName){
    if (sourceBtn.style.display == 'none'){
        sourceBtn.style.display = 'inline-block';
        console.log('source');
    }
    const imageAddy = document.getElementById('imageAddy');
    ...
    let placeDescLink = document.getElementById('sourceLink');
    imageAddy.textContent = placesLocations[pos];
